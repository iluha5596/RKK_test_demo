...
class PreparationTransactionLocators:
    ...
    TOTAL_COST_BOX = (
    By.XPATH, '//*[text()="Коробка КК"]/../../../../../../../../../../..//input[@field-code="amount"]')
    ...
    CONTRACT_NUMBER = (
    By.XPATH, r'//label[@title="Номер договора \ сертификата"]/..//input[@field-code="reqContractNumber"]')
    CONTRACT_DATA = (
    By.XPATH, r'//label[@title="Дата договора \ сертификата"]/..//input[@field-code="reqContractDate"]')
    BOX_TWO = (By.XPATH, '//span[text()="Коробка №2"]')
    REQUISITES_BOX_ACCEPT = (By.XPATH, '//span[text()="Принять"]')
    CLIENT_AGREES = (By.XPATH,
                     '//*[text()="Клиент согласен (печать и подписание договора, при необходимости обновление карточки клиента в ЦФТ)"]'
